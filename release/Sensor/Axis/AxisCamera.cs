...
namespace Scallop.Sensor.Axis
{
  ...
  public class AxisCameraClass : IScallopSensor, IDisposable
  {
    ...
    public AxisCameraClass()
    {
      try
      {
        Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Axis.AxisCameraConfig.xsd");
        ...
        */
        ...
        switch (this.camParams.frameFormat)
        {
          ...
          case "System.Drawing.Bitmap":
            Bitmap bmp = (Bitmap)(Bitmap.FromStream(new MemoryStream(frameBuffer)).Clone());
            if (bmp != null)
